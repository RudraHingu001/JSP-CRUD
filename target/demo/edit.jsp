                    ...
                    try{
                        ...
                        while(true){
                            ...
                            if(rs.next()){
                                ...
                                out.println("<form method='post' action='edit_table.jsp?id="+id+"'");
                                out.println("<tr>");
                                out.println("<td colspan=2><center>Edit Student Details</center></td>");
                                out.println("</tr>");
                                out.println("<tr>");
                                out.println("<th scope='col'>Name</th>");
                                out.println("<td><input type='text' value='"+rs.getString("name")+"' name='name'></td>");
                                out.println("</tr>");
                                out.println("<tr>");
                                out.println("<th scope='col'>Phone Number</th>");
                                out.println("<td><input type='number' value='"+rs.getLong("phone")+"' name='phone'></td>");
                                out.println("</tr>");
                                out.println("<tr>");
                                out.println("<td colspan=2><center><input type='submit' class='btn btn-primary'></center></td>");
                                out.println("</tr>");
                                out.println("</form>");
